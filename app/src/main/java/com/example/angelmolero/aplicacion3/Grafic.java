...
public class Grafic {
    ...
    private int amplada, altura;//Dimensions de la imate
    private double incX, incY;//Velocitat desplaçament
    private double angle, rotacio;//Angle i velocitat rotacio
    ...
    private View view; //On dibuixem el gràfic (Utilitzat en view.invalidate)
